    ...
    public partial class AddSeeds2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Nowa formula", "Oktosept", "Przeciw-alergiczny" },
                    { 2, "Spray do nosa", "Otrivin", "Udrazniajacy" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 5, 7, 17, 14, 2, 681, DateTimeKind.Local).AddTicks(7457), "Adam", "Adamowski" },
                    { 2, new DateTime(2021, 5, 7, 17, 14, 2, 688, DateTimeKind.Local).AddTicks(5172), "Adam2", "Adamowski2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 5, 7, 17, 14, 2, 689, DateTimeKind.Local).AddTicks(7379), new DateTime(2021, 5, 7, 17, 14, 2, 689, DateTimeKind.Local).AddTicks(7850), 1, 1 },
                    { 2, new DateTime(2021, 5, 7, 17, 14, 2, 689, DateTimeKind.Local).AddTicks(9970), new DateTime(2021, 5, 7, 17, 14, 2, 689, DateTimeKind.Local).AddTicks(9999), 2, 2 }
                });
