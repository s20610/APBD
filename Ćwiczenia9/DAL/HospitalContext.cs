...
namespace APDB08.DAL
{
    public partial class HospitalContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => new{e.RefreshToken, e.RefreshTokenExpirationDate});
                entity.HasData(new LoginRequest()
                {
                    Login = "Login",
                    Password = "password"
                });
